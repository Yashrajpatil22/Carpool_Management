...
import { Car, Mail, Lock, ArrowRight, Chrome, Eye, EyeOff } from 'lucide-react';
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_BASE_URL || 'http://localhost:7777'}/api/auth/login`, {
        method: 'POST',
        headers: {
